...
export const formSchema = z.object({
    ...
    names: z.string().min(2, "Mínimo 2 caracteres"),
    last_names: z.string().min(2, "Mínimo 2 caracteres"),
    dni: z.string().min(2, "Mínimo 2 caracteres"),
    certifier: z.string().nullable().optional(),
